...
const db = {
    createTable: () => {
        const sql = "CREATE TABLE test_table (id INT AUTO_INCREMENT, firstname VARCHAR(25), lastname VARCHAR(25), PRIMARY KEY(id));"
        conn.query(sql, (err) => {
            if(err){throw err;}
    ...
    inserData: () => {
        return new Promise( (resolve, reject) => {
            const data = {firstname: "JB", lastname: "Dumalaga"};
    ...
    updateData: (id) => {
        return new Promise( (resolve, reject) => {
            const data = {id: id, firstname: "JB", lastname: "Dumalaga"};
